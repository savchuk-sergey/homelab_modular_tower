...
- Export copy: `revisions/mk0.9/review_package/exports/`
- Analysis CSV files: `revisions/mk0.9/review_package/analysis/`
- Manifest documents: `revisions/mk0.9/review_package/manifests/`
- Revision notes copy: `revisions/mk0.9/review_package/revision_notes/`
- Assembly overview: `revisions/mk0.9/review_package/ASSEMBLY_OVERVIEW.md`
- Requirements checklist: `revisions/mk0.9/review_package/REVIEW_REQUIREMENTS_CHECKLIST.md`
...
- `revisions/mk0.9/analysis/part_dimensions.csv`
- `revisions/mk0.9/analysis/printability_check.csv`
- `revisions/mk0.9/analysis/plastic_estimate.csv`
- `revisions/mk0.9/analysis/stl_quality.csv`
- `revisions/mk0.9/analysis/duplicate_geometry_check.csv`
- `revisions/mk0.9/PRINTABLE_PARTS.md`
- `revisions/mk0.9/NON_PRINTABLE_PARTS.md`
- `revisions/mk0.9/PLACEHOLDERS.md`
- `revisions/mk0.9/REVIEW_GEOMETRY.md`
- `revisions/mk0.9/review_package/REVIEW_REQUIREMENTS_CHECKLIST.md`
- `revisions/mk0.9/review_package/ASSEMBLY_OVERVIEW.md`