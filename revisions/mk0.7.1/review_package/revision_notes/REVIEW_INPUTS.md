...
- Export copy: `revisions/mk0.7.1/review_package/exports/`
- Analysis CSV files: `revisions/mk0.7.1/review_package/analysis/`
- Manifest documents: `revisions/mk0.7.1/review_package/manifests/`
- Revision notes copy: `revisions/mk0.7.1/review_package/revision_notes/`
- Assembly overview: `revisions/mk0.7.1/review_package/ASSEMBLY_OVERVIEW.md`
- Requirements checklist: `revisions/mk0.7.1/review_package/REVIEW_REQUIREMENTS_CHECKLIST.md`
