"""Generate the current revision review package and ZIP archive."""
...
def main() -> None:
    ...
    if args.revision != cfg.CURRENT_REVISION:
        raise SystemExit(f"Refusing to package {args.revision}; current revision is {cfg.CURRENT_REVISION}.")
